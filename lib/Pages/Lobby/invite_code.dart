...
//
//
//                                     // Set invitationCode directly to _inviteCodeController and ColorDicePicker
//                                     _inviteCodeController.text = zoneData["InvitationCode"];
//                                     invitationCode = zoneData["InvitationCode"]; // Assigning invitation code
//                                     print(invitationCode);
//                                     print(_inviteCodeController.text);
//                                     Clipboard.setData(ClipboardData(text: zoneData["InvitationCode"])).then((_) {
...
//                                     });
//                                     //
//                                     // Get.to(ColorDicePicker(maxPlayer: zoneData["maxPlayers"])); // Pass maxPlayer dynamically
//                                   },
//                                   child: Text("Copy"),
//                                 ),
//                               ),
