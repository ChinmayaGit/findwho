...
//if you enable this three line 1st it will add the invite code from user field which be like NA so never add this:
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Column(
                  children: [
                    playerCounter(inProgress),
                    create(inProgress, context),
                    join(inProgress, context),
                  ],
                ),
              ),
            ],
  ...
  create(bool inProgress, context) {
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.all(8.0),
            ...
            ? GestureDetector(
                onTap: () async {
                  if (inProgress == false) {
                    ...
                    customToast(
                        msg: "This mode is in development", context: context);
                  }
                },
                child: Container(
                  height: 50,
        ...
        child: GestureDetector(
          onTap: () {
            if (inProgress == false) {
              ...
              customToast(msg: "This mode is in development", context: context);
            }
            // getData().then((value) {
            //   Get.to(InviteCode());
            // });
                ...
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          "1st round: You have to find the room which has evidence"),
                      Text("2nd round: Find the weapon used"),
                      Text("3rd round: Find who killed"),
                      Text(
                          "In every round, everyone will get an equal number of cards for rooms, weapons, and people"),
                      Text(
                          "The cards they have will be shown below—they are out of the suspect list"),
                      Text(
                          "You need to find the missing cards that no one has"),
                    ],
                  ),
                  actions: <Widget>[
                    TextButton(
              ...
              builder: (BuildContext context) {
                ...
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: <Widget>[
                      Text(
                          "This game is developed by a solo developer, and I am doing my best to address any bugs that may arise. If you encounter any issues or have any suggestions for improvement, I kindly ask for your support and feedback. Your help is greatly appreciated as I continue to enhance the game."),
                    ],
                  ),
                  actions: <Widget>[
                    TextButton(
