      ...
      body: Obx(() {
        ...
        if (_zoneGameController.zoneGameCollection.isEmpty) {
          return Column(
            children: [
              Expanded(
                  child: Center(child: Text('Others have left the game!'))),
              Expanded(
                child: Center(
        ...
        if (_zoneController.zoneDoc.value!.page != 3) {
          return SafeArea(
              child: Stack(
                ...
                child: _zoneController.zoneDoc.value!.page == 0
                    ...
                    : _zoneController.zoneDoc.value!.page == 1
                        ? gridContent<WeaponModel>(
                            objects: _zoneDataController
                                    .zoneDataDoc.value?.weapons ??
                                [],
                            assetName: "weapons",
                            context: context)
                        : gridContent<PersonModel>(
                            objects: _zoneDataController
                                    .zoneDataDoc.value?.persons ??
                                [],
                            assetName: "persons",
                            context: context),
              ),
